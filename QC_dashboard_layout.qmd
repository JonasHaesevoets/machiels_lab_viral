...
write_rds(filtered_seurat_obj, file = paste0(file_path$intermediate_data,file_name_obj,"_filtered","rds" ))
...
```
```{r}
#| title: fraction multiplets, by quantile
 seurat_obj |>  
...
```{r}
#| title: fraction multiplets, by  nCount
 seurat_obj |>  
...
#| title: cluster 0
feature_umap(clus_0_genes, title_= title_feature_umap_clus_1, caption_ = caption_feature_umap_clus_1) 
```
