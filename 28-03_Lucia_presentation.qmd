...
Idents(seurat_d60_1_alveolar_bal) = "sampletag_name"
...
Idents(seurat_d60_1_alveolar_lung) = "sampletag_name"
...
write_xlsx(MuHV4_Ms4a3pos_markers, "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/h)/MuHV4_Ms4a3pos_markers.xlsx")
...
write_xlsx(MuHV4_Ms4a3pos_markers, "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/h)/MuHV4_Ms4a3neg_markers.xlsx")
...
write_xlsx(PR8_Ms4a3neg_markers, "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/h)/PR8_Ms4a3neg_markers.xlsx")
...
write_xlsx(PR8_Ms4a3pos_markers, "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/h)/PR8_Ms4a3pos_markers.xlsx")
...
write_xlsx(PVM_Ms4a3pos_markers, "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/h)/PVM_Ms4a3pos_markers.xlsx")
...
write_xlsx(PVM_Ms4a3neg_markers, "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/h)/PVM_Ms4a3neg_markers.xlsx")
...
write_xlsx(MAV1_Ms4a3pos_markers, "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/h)/MAV1_Ms4a3pos_markers.xlsx")
...
write_xlsx(MAV1_Ms4a3neg_markers, "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/h)/MAV1_Ms4a3neg_markers.xlsx")
...
write_xlsx(MAV1_Ms4a3pos_markers, "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/h)/Mock_Ms4a3pos_markers.xlsx")
...
write_xlsx(MAV1_Ms4a3neg_markers, "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/h)/Mock_Ms4a3neg_markers.xlsx")
```

# 9) GSEA of MuHV4_Ms4a3+
...
```{r}
MuHV4_Ms4a3pos = read_xlsx("../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/markers_alveolar_nomock_MuHv4posfiltered.xlsx")
...
```{r}
dotplot(gse_MuHV4_Ms4a3_kegg, showCategory = 10, title = "Enriched Pathways" , split=".sign") + facet_grid(.~.sign)
```

# 10) GSEA of MuHV4 Ms4a3 -

```{r}
analyze_gsea_and_kegg <- function(data_file, organism, data) {
  # Read data from Excel file
  # Replace 'data' with the actual variable name containing your data
  data <- read_xlsx(data_file)
  ...
  # Perform GSEA analysis (adjusted p-value not calculated)
 ...
 # Generate dotplot for GSEA results
  gsea_plot <- dotplot(gse_result, showCategory = 10, split = ".sign") + 
                facet_grid(.~.sign)
  
  # Save the plot using ggsave with a constructed filename
  ggsave(paste0("dotPlot_[data_name]_GO.png", sep = ""), gsea_plot,
         width = 30, height = 35, units = "cm", 
         path = "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/GSEA/[data_name]")
  
  # Similar approach for ridgeplot
  ridgeplot_plot <- ridgeplot(gse_result) + labs(x = "enrichment distribution")
  ggsave(paste0("ridge_[data_name]_GO.png", sep = ""), ridgeplot_plot,
         width = 30, height = 35, units = "cm", 
         path = "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/GSEA/[data_name]")
  ...
  # Filter dataframe based on successful mapping
  filtered_data <- data[data$gene %in% dedup_ids$SYMBOL, ]
  filtered_data$Y <- dedup_ids$ENTREZID
  
  # Create gene list for KEGG pathway analysis
  kegg_gene_list <- filtered_data$avg_log2FC
  names(kegg_gene_list) <- filtered_data$Y
  kegg_gene_list <- na.omit(kegg_gene_list)
  kegg_gene_list <- sort(kegg_gene_list, decreasing = TRUE)
  
  # Return the gene list for further KEGG analysis (replace 'd' with your KEGG analysis code)
  return(kegg_gene_list)
}
```

```{r}
data_file <- "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/markers_alveolar_nomock_neg_MuHV4_filtered.xlsx"

# Analyze GSEA and KEGG pathways
kegg_gene_list <- analyze_gsea_and_kegg(data_file, organism, my_data)
```

# 11) GSEA of PR8 Ms4a3 -

```{r}
data_file <- "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/markers_alveolar_nomock_PR8_neg_filtered.xlsx"
...
```{r}
data_file <- "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/markers_alveolar_nomock_PR8posfiltered.xlsx"

# Analyze GSEA and KEGG pathways
kegg_gene_list <- analyze_gsea_and_kegg(data_file, organism, my_data)
```

# 12) GSEA of PVM Ms4a3 +

```{r}
data_file <- "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/markers_alveolar_nomock_PVMposfiltered.xlsx"
...
```{r}
data_file <- "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/markers_alveolar_nomock_PVM_neg_filtered.xlsx"

# Analyze GSEA and KEGG pathways
kegg_gene_list <- analyze_gsea_and_kegg(data_file, organism, my_data)
```

# 13) GSEA of MAV1 Ms4a3 -

```{r}
data_file <- "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/markers_alveolar_nomock_MAV1_neg_filtered.xlsx"

# Analyze GSEA and KEGG pathways
kegg_gene_list <- analyze_gsea_and_kegg(data_file, organism, my_data)
```

# 14) GSEA of MAV1 Ms4a3 +

```{r}
data_file <- "../../Documents/machiels_lab_viral/28-03_Lucia_presentation_files/DEA/markers_alveolar_nomock_MAV1posfiltered.xlsx"

# Analyze GSEA and KEGG pathways
kegg_gene_list <- analyze_gsea_and_kegg(data_file, organism, my_data)
```

# 19) Heatmap markers daniel 'clusters_gene_set.xlsx' for full object
