...
genes_in_data = 
gmt_file <- "../../Documents/machiels_lab_viral/Background_genes/background.gmt"
...
ggsave("gsea_table_dnavsrna.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/dnavsrna/", bg = 'white', width = 26, height = 26)
ggsave("gsea_table_dnavsrna.svg", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/dnavsrna/", bg = 'white', width = 26, height = 26)
...
ggsave("gsea_barplot.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/dnavsrna/", bg = 'white', width = 26, height = 26)
```
...
ggsave("gsea_table_dnavsMock.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/dnavsMock/", bg = 'white', width = 26, height = 26)
ggsave("gsea_table_dnavsMock.svg", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/dnavsMock/", bg = 'white', width = 26, height = 26)
...
ggplot(topPathways, aes(x = reorder(pathway, NES), y = NES)) +
  ...
  theme(plot.title = element_text(size = 25),
        ...
        axis.title.y = element_text(size = 20),
        axis.text = element_text(size = 18))
ggsave("gsea_barplot.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/dnavsMock/", bg = 'white', width = 26, height = 26)
```
...
ggsave("gsea_table_rnavsmock.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/rnavsmock/", bg = 'white', width = 26, height = 26)
ggsave("gsea_table_rnavsmock.svg", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/rnavsmock/", bg = 'white', width = 26, height = 26)
...
ggplot(topPathways, aes(x = reorder(pathway, NES), y = NES)) +
  ...
  theme(plot.title = element_text(size = 25),
        ...
        axis.title.y = element_text(size = 20),
        axis.text = element_text(size = 18))
ggsave("gsea_barplot.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/rnavsMock/", bg = 'white', width = 26, height = 26)
```
...
ggsave("gsea_table_mav1vsmock.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/mav1vsmock/", bg = 'white', width = 26, height = 26)
ggsave("gsea_table_mav1vsmock.svg", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/mav1vsmock/", bg = 'white', width = 26, height = 26)
...
ggsave("gsea_table_muhv4vsmock.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/muhv4vsmock/", bg = 'white', width = 26, height = 26)
ggsave("gsea_table_muhv4vsmock.svg", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/muhv4vsmock/", bg = 'white', width = 26, height = 26)
...
ggsave("gsea_table_pr8vsmock.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/pr8vsmock/", bg = 'white', width = 26, height = 26)
ggsave("gsea_table_pr8vsmock.svg", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/pr8vsmock/", bg = 'white', width = 26, height = 26)
...
ggsave("gsea_table_pvmvsmock.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/pvmvsmock/", bg = 'white', width = 26, height = 26)
ggsave("gsea_table_pvmvsmock.svg", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/pvmvsmock/", bg = 'white', width = 26, height = 26)
...
ggsave("gsea_table_mav1ms4a3.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/mav1ms4a3/", bg = 'white', width = 26, height = 26)
ggsave("gsea_table_mav1ms4a3.svg", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/mav1ms4a3/", bg = 'white', width = 26, height = 26)
...
ggsave("gsea_table_muhv4ms4a3.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/muhv4ms4a3/", bg = 'white', width = 26, height = 26)
ggsave("gsea_table_muhv4ms4a3.svg", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/muhv4ms4a3/", bg = 'white', width = 26, height = 26)
...
ggplot(GSEAres_muhv4ms4a3_p, aes(x = reorder(pathway, NES), y = NES)) +
  ...
  theme(plot.title = element_text(size = 25),
        ...
        axis.title.y = element_text(size = 20),
        axis.text = element_text(size = 18))
ggsave("gsea_barplot.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/muhv4ms4a3/", bg = 'white', width = 26, height = 26)
```
...
ggsave("gsea_table_pr8ms4a3.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/pr8ms4a3/", bg = 'white', width = 26, height = 26)
ggsave("gsea_table_pr8ms4a3.svg", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/pr8ms4a3/", bg = 'white', width = 26, height = 26)
...
ggsave("gsea_table_pvmms4a3.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/pvmms4a3/", bg = 'white', width = 26, height = 26)
ggsave("gsea_table_pvmms4a3.svg", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/pvmms4a3/", bg = 'white', width = 26, height = 26)
...
ggsave("gsea_table_ms4a3.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/ms4a3/", bg = 'white', width = 26, height = 26)
ggsave("gsea_table_ms4a3.svg", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/ms4a3/", bg = 'white', width = 26, height = 26)
...
# 14) GSEA MAV1 vs All (nomock)

## 14.1 Load in the genes to be analyzed for GSEA

```{r}
MuHV4vsAll = readxl::read_xlsx("../../Documents/machiels_lab_viral/CaseStudy_DEA/DEA_tables/markers_MuHV4vsAll.xlsx")

```

```{r}
MuHV4versusAll = ranker(MuHV4vsAll)
head(MuHV4versusAll)
```

## 14.2 Subset to the genes that are present in our data to avoid bias
...
## 14.3 Run GSEA with fgsea

```{r}
GSEAres_MuHV4vsAll<- fgsea(pathways = final_list, # List of gene sets to check
                 stats = MuHV4versusAll,
                 scoreType = 'std', # in this case we have both pos and neg rankings. 
                 minSize = 1,
                 maxSize = 500,
                 nproc = 1) # for parallelisation
...
## 14.4 Visualize results fgsea

```{r}
# Top  enriched pathways (ordered by p-val adjusted)
head(GSEAres_MuHV4vsAll[order(pval), ])
sum(GSEAres_MuHV4vsAll[, pval < 0.05])
...
```{r}
# select the top 25 pathways associated with up / down regulated genes
topPathwaysUp_MuHV4versusAll <- GSEAres_MuHV4vsAll[ES > 0 & pval < 0.05][head(order(pval), n = 25), pathway]
topPathwaysDown_dnsvsrna <- GSEAres_MuHV4vsAll[ES < 0 & pval < 0.05][head(order(pval), n = 25), pathway]
topPathways_MuHV4versusAll = c(topPathwaysUp_MuHV4versusAll, rev(topPathwaysDown_dnsvsrna))
```

```{r}
#plot the gsea table plot
plotGseaTable(final_list[topPathways_MuHV4versusAll], MuHV4versusAll, GSEAres_MuHV4vsAll, gseaParam = 1)
ggsave("gsea_table_MuHV4versusAll.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/MuHV4versusAll/", bg = 'white', width = 26, height = 26)
ggsave("gsea_table_MuHV4versusAll.svg", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/MuHV4versusAll/", bg = 'white', width = 26, height = 26)

```

```{r}
# plot enrichment score (ES) of most significantly enriched path
for (i in topPathways_MuHV4versusAll) {
  plot <- plotEnrichment(final_list[[i]], MuHV4versusAll) +
  labs(title =  i)

  # Generate filename with unique identifier
  filename <- paste0("enrichment_plot", i, ".png") 
  full_path <- paste0("../../Documents/machiels_lab_viral/CaseStudy_GSEA/MuHV4versusAll/", filename)
...
```{r}
GSEAres_MuHV4vsAll_p <- GSEAres_MuHV4vsAll %>% filter(pval < 0.05)

# Select the top 10 pathways based on NES
topPathways <- GSEAres_MuHV4vsAll_p %>% top_n(25, wt = abs(NES))
...
ggplot(topPathways, aes(x = reorder(pathway, NES), y = NES)) +
  ...
  theme(plot.title = element_text(size = 25),
        ...
        axis.title.y = element_text(size = 20),
        axis.text = element_text(size = 18))
ggsave("gsea_barplot.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/MuHV4versusAll/", bg = 'white', width = 26, height = 26)
```

```{r}
GSEAres_MuHV4vsAll <- GSEAres_MuHV4vsAll %>%
    as_tibble() %>%
    rowwise() %>%
    mutate(leadingEdge = paste(leadingEdge, collapse = ","))
write_xlsx(GSEAres_MuHV4vsAll, path = "../../Documents/machiels_lab_viral/CaseStudy_GSEA/MuHV4versusAll/fgsea_results.xlsx")

```

# 15) GSEA MAV1 vs All (nomock)

## 15.1 Load in the genes to be analyzed for GSEA

```{r}
MAV1vsAll = readxl::read_xlsx("../../Documents/machiels_lab_viral/CaseStudy_DEA/DEA_tables/markers_MAV1vsAll.xlsx")

```

```{r}
MAV1versusAll = ranker(MAV1vsAll)
head(MAV1versusAll)
```

## 15.2 Subset to the genes that are present in our data to avoid bias
...
## 15.3 Run GSEA with fgsea

```{r}
GSEAres_MAV1vsAll<- fgsea(pathways = final_list, # List of gene sets to check
                 stats = MAV1versusAll,
                 scoreType = 'std', # in this case we have both pos and neg rankings. 
                 minSize = 1,
                 maxSize = 500,
...
## 15.4 Visualize results fgsea

```{r}
# Top  enriched pathways (ordered by p-val adjusted)
head(GSEAres_MAV1vsAll[order(pval), ])
sum(GSEAres_MAV1vsAll[, pval < 0.05])
...
```{r}
# select the top 25 pathways associated with up / down regulated genes
topPathwaysUp_MAV1versusAll <- GSEAres_MAV1vsAll[ES > 0 & pval < 0.05][head(order(pval), n = 25), pathway]
topPathwaysDown_dnsvsrna <- GSEAres_MAV1vsAll[ES < 0 & pval < 0.05][head(order(pval), n = 25), pathway]
topPathways_MAV1versusAll = c(topPathwaysUp_MAV1versusAll, rev(topPathwaysDown_dnsvsrna))
```

```{r}
#plot the gsea table plot
plotGseaTable(final_list[topPathways_MAV1versusAll], MAV1versusAll, GSEAres_MAV1vsAll, gseaParam = 1)
ggsave("gsea_table_MAV1versusAll.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/MAV1versusAll/", bg = 'white', width = 26, height = 26)
ggsave("gsea_table_MAV1versusAll.svg", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/MAV1versusAll/", bg = 'white', width = 26, height = 26)

```

```{r}
# plot enrichment score (ES) of most significantly enriched path
for (i in topPathways_MAV1versusAll) {
  plot <- plotEnrichment(final_list[[i]], MAV1versusAll) +
  labs(title =  i)

  # Generate filename with unique identifier
  filename <- paste0("enrichment_plot", i, ".png") 
  full_path <- paste0("../../Documents/machiels_lab_viral/CaseStudy_GSEA/MAV1versusAll/", filename)
...
```{r}
GSEAres_MAV1vsAll_p <- GSEAres_MAV1vsAll %>% filter(pval < 0.05)

# Select the top 10 pathways based on NES
topPathways <- GSEAres_MAV1vsAll_p %>% top_n(25, wt = abs(NES))
...
ggplot(topPathways, aes(x = reorder(pathway, NES), y = NES)) +
  ...
  theme(plot.title = element_text(size = 25),
        ...
        axis.title.y = element_text(size = 20),
        axis.text = element_text(size = 18))
ggsave("gsea_barplot.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/MAV1versusAll/", bg = 'white', width = 26, height = 26)
```

```{r}
GSEAres_MAV1vsAll <- GSEAres_MAV1vsAll %>%
    as_tibble() %>%
    rowwise() %>%
    mutate(leadingEdge = paste(leadingEdge, collapse = ","))
write_xlsx(GSEAres_MAV1vsAll, path = "../../Documents/machiels_lab_viral/CaseStudy_GSEA/MAV1versusAll/fgsea_results.xlsx")

```

# 16) GSEA PR8 vs All (no mock)

## 16.1 Load in the genes to be analyzed for GSEA

```{r}
PR8vsAll = readxl::read_xlsx("../../Documents/machiels_lab_viral/CaseStudy_DEA/DEA_tables/markers_PR8vsAll.xlsx")

```

```{r}
PR8versusAll = ranker(PR8vsAll)
head(PR8versusAll)
```

## 16.2 Subset to the genes that are present in our data to avoid bias
...
## 16.3 Run GSEA with fgsea

```{r}
GSEAres_PR8vsAll<- fgsea(pathways = final_list, # List of gene sets to check
                 stats = PR8versusAll,
                 scoreType = 'std', # in this case we have both pos and neg rankings. 
                 minSize = 1,
                 maxSize = 500,
...
## 16.4 Visualize results fgsea

```{r}
# Top  enriched pathways (ordered by p-val adjusted)
head(GSEAres_PR8vsAll[order(pval), ])
sum(GSEAres_PR8vsAll[, pval < 0.05])
...
```{r}
# select the top 25 pathways associated with up / down regulated genes
topPathwaysUp_PR8versusAll <- GSEAres_PR8vsAll[ES > 0 & pval < 0.05][head(order(pval), n = 25), pathway]
topPathwaysDown_dnsvsrna <- GSEAres_PR8vsAll[ES < 0 & pval < 0.05][head(order(pval), n = 25), pathway]
topPathways_PR8versusAll = c(topPathwaysUp_PR8versusAll, rev(topPathwaysDown_dnsvsrna))
```

```{r}
#plot the gsea table plot
plotGseaTable(final_list[topPathways_PR8versusAll], PR8versusAll, GSEAres_PR8vsAll, gseaParam = 1)
ggsave("gsea_table_PR8versusAll.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/PR8versusAll/", bg = 'white', width = 26, height = 26)
ggsave("gsea_table_PR8versusAll.svg", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/PR8versusAll/", bg = 'white', width = 26, height = 26)

```

```{r}
# plot enrichment score (ES) of most significantly enriched path
for (i in topPathways_PR8versusAll) {
  plot <- plotEnrichment(final_list[[i]], PR8versusAll) +
  labs(title =  i)

  # Generate filename with unique identifier
  filename <- paste0("enrichment_plot", i, ".png") 
  full_path <- paste0("../../Documents/machiels_lab_viral/CaseStudy_GSEA/PR8versusAll/", filename)
...
```{r}
GSEAres_PR8vsAll_p <- GSEAres_PR8vsAll %>% filter(pval < 0.05)

# Select the top 10 pathways based on NES
topPathways <- GSEAres_PR8vsAll_p %>% top_n(25, wt = abs(NES))
...
ggplot(topPathways, aes(x = reorder(pathway, NES), y = NES)) +
  ...
  theme(plot.title = element_text(size = 25),
        ...
        axis.title.y = element_text(size = 20),
        axis.text = element_text(size = 18))
ggsave("gsea_barplot.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/PR8versusAll/", bg = 'white', width = 26, height = 26)
```

```{r}
GSEAres_PR8vsAll <- GSEAres_PR8vsAll %>%
    as_tibble() %>%
    rowwise() %>%
    mutate(leadingEdge = paste(leadingEdge, collapse = ","))
write_xlsx(GSEAres_PR8vsAll, path = "../../Documents/machiels_lab_viral/CaseStudy_GSEA/PR8versusAll/fgsea_results.xlsx")

```

# 17) GSEA PVM vs All (no mock)

## 17.1 Load in the genes to be analyzed for GSEA

```{r}
PVMvsAll = readxl::read_xlsx("../../Documents/machiels_lab_viral/CaseStudy_DEA/DEA_tables/markers_PVMvsAll.xlsx")

```

```{r}
PVMversusAll = ranker(PVMvsAll)
head(PVMversusAll)
```

## 17.2 Subset to the genes that are present in our data to avoid bias
...
## 17.3 Run GSEA with fgsea

```{r}
GSEAres_PVMvsAll<- fgsea(pathways = final_list, # List of gene sets to check
                 stats = PVMversusAll,
                 scoreType = 'std', # in this case we have both pos and neg rankings. 
                 minSize = 1,
                 maxSize = 500,
...
## 17.4 Visualize results fgsea

```{r}
# Top  enriched pathways (ordered by p-val adjusted)
head(GSEAres_PVMvsAll[order(pval), ])
sum(GSEAres_PVMvsAll[, pval < 0.05])
...
```{r}
# select the top 25 pathways associated with up / down regulated genes
topPathwaysUp_PVMversusAll <- GSEAres_PVMvsAll[ES > 0 & pval < 0.05][head(order(pval), n = 25), pathway]
topPathwaysDown_dnsvsrna <- GSEAres_PVMvsAll[ES < 0 & pval < 0.05][head(order(pval), n = 25), pathway]
topPathways_PVMversusAll = c(topPathwaysUp_PVMversusAll, rev(topPathwaysDown_dnsvsrna))
```

```{r}
#plot the gsea table plot
plotGseaTable(final_list[topPathways_PVMversusAll], PVMversusAll, GSEAres_PVMvsAll, gseaParam = 1)
ggsave("gsea_table_PVMversusAll.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/PVMversusAll/", bg = 'white', width = 26, height = 26)
ggsave("gsea_table_PVMversusAll.svg", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/PVMversusAll/", bg = 'white', width = 26, height = 26)

```

```{r}
# plot enrichment score (ES) of most significantly enriched path
for (i in topPathways_PVMversusAll) {
  plot <- plotEnrichment(final_list[[i]], PVMversusAll) +
  labs(title =  i)

  # Generate filename with unique identifier
  filename <- paste0("enrichment_plot", i, ".png") 
  full_path <- paste0("../../Documents/machiels_lab_viral/CaseStudy_GSEA/PVMversusAll/", filename)
...
```{r}
GSEAres_PVMvsAll_p <- GSEAres_PVMvsAll %>% filter(pval < 0.05)

# Select the top 10 pathways based on NES
topPathways <- GSEAres_PVMvsAll_p %>% top_n(25, wt = abs(NES))
...
ggplot(topPathways, aes(x = reorder(pathway, NES), y = NES)) +
  ...
  theme(plot.title = element_text(size = 25),
        ...
        axis.title.y = element_text(size = 20),
        axis.text = element_text(size = 18))
ggsave("gsea_barplot.png", path ="../../Documents/machiels_lab_viral/CaseStudy_GSEA/PVMversusAll/", bg = 'white', width = 26, height = 26)
```

```{r}
GSEAres_PVMvsAll <- GSEAres_PVMvsAll %>%
    as_tibble() %>%
    rowwise() %>%
    mutate(leadingEdge = paste(leadingEdge, collapse = ","))
write_xlsx(GSEAres_PVMvsAll, path = "../../Documents/machiels_lab_viral/CaseStudy_GSEA/PVMversusAll/fgsea_results.xlsx")
