...
new_meta_data <- obj.v5 |> 
  ...
  mutate(day_sample_type = paste(day, sample_type, sep="_"),
         day_mock = ifelse(condition == "Mock", paste(day, "Mock", sep="_"), paste(day, sample_type, sep="_")),
         day_mock_sample_type = ifelse(condition == "Mock", paste("Mock", sample_type, sep="_"), paste(day, sample_type, sep="_")),
         day_sample_type_cond = paste(day, sample_type, condition, sep="_"),
         day_mock_sample_type_cond = paste(day_mock, condition, sep="_"),
  ...
  mutate(day_sample_type_cond_ms4a3_pos_gabbr2 = paste(day, sample_type, condition, sample_tag_ms4a3_pos_gabbr2, sep="_")) |> 
...
obj.v5 |>  write_rds("../../Documents/machiels_lab_viral/intermediate_data/seurat_obj_central_daniel.rds")
