...
## 6.2.6 Regress out effect of cell cycle

```{r}
seurat_d60_bal_filtered_normalized <- ScaleData(seurat_d60_bal_filtered_normalized, vars.to.regress = c("S.Score", "G2M.Score"))
