...
```{r}
obj.v5$seurat_clusters = obj.v5$cluster_8_subclusters
Idents(obj.v5) = "seurat_clusters"
obj.v5 <- subset(obj.v5, idents = c("4"), invert = TRUE)
obj.v5$seurat_clusters = factor(obj.v5$seurat_clusters, levels = c("0", "1", "2", "3","5","6","7","8_0","8_1","8_2"))
...
combined_plot
ggsave("sample_Embeddings_originalIntegratedSeuratObject.png", plot = combined_plot, path = "../../Documents/machiels_lab_viral/Case_study_annotation/exploration/recluster/", height = 20, width = 18)
```
