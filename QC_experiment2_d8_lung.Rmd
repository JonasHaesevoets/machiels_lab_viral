...
### 6.2.5 Regress out effect of cell cycle

```{r}
seurat_d8_lung_filtered_normalized <- ScaleData(seurat_d8_lung_filtered_normalized, vars.to.regress = c("S.Score", "G2M.Score"))
...
seurat_d8_lung_filtered_normalized$gender <- seurat_d8_lung_filtered_normalized |> 
