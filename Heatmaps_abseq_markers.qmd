...
featureplot_d8_tissue_cd274 = FeaturePlot(seurat_onlyd8, features = c("Cd274-AbSeq"), reduction = "umap.harmony_8dims", label = T, split.by = "day_mock", cols = c("green", "red")) & theme(legend.position = "right")
