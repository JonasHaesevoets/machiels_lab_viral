...
markers_ms4a3_pos <- FindMarkers(obj.v5 , ident.1 =  "Ms4a3_pos", ident.2 =  "Ms4a3_neg", test.use = "roc", max.cells.per.ident = 1000,min.pct = 0.2,logfc.threshold = 0.5 ,only.pos = T)|> as_tibble(rownames="gene") |> mutate("sampletag_Ms4a3"="Ms4a3_pos")

markers_ms4a3 <- bind_rows(head(markers_ms4a3_neg),head(markers_ms4a3_pos))
...
Gabbr2, Siglecf, Csf1r, Actn1 and Cd2 are among the top genes globally differentiating Ms4a3+ fro Ms4a3- macrophages in all 4 sequenced batches.  Due to the measurement of high levels of Gabbr2 with very low p-values in cells sorted as Ms4a3+ (=Tomato+) it is hypothesized here that Gabbr2 is either a alignemnt artifact or a biolgical consequence of 
...
p3
MuHV4_D14 |> FeatureScatter("Siglecf","Gabbr2" )
```


Gabbr2 is very lowly expressed in lung cells of wildtype mice.
#gabbr2 expression in Ms4a3-tomato-mice
